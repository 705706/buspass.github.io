    ...
    <header class="site-navbar py-1" role="banner">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-10 col-md-8 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <div class="site-blocks-cover inner-page-cover print" style="background-image: url(images/businside.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            <div class="mb-5">
              <h3 class="footer-heading mb-4">About Bus Pass</h3>
              <p>Provides student a pass for their daily life to travel to/from S.S.P.M. College of engineering,Kankavli</p>
            </div>
